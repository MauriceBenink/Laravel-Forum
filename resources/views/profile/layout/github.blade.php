<div class="form-group{{ $errors->has('github') ? ' has-error' : '' }}">
    <label for="github" class="col-md-4 control-label">GitHub:<b style = font-size:10px;> https://github.com/<i style = color:red>copy paste this part of the url only</i></b></label>
