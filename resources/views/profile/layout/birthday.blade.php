<div class="form-group{{ $errors->has('bday') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        <input id="bday" type="date" class="form-control" name="bday" value="{{ isset($object->birthday)&&!is_null($object->birthday)? Carbon\Carbon::parse($object->birthday)->toDateString():''}}" autofocus>
        @if ($errors->has('bday'))
